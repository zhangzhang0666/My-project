...
namespace TarodevController
{
    ...
    public class PlayerController2D : MonoBehaviour, IPlayerController
    {
        ...
        private void Awake()
        {
            ...
            spAni = sprite.GetComponent<Animator>();
            Instance = this;
            Jumped += OnJumped;
        }
        ...
        private void Animate()
        {
            ...
            if (_frameInput.Move.x != 0)
            {
                sprite.GetComponent<SpriteRenderer>().flipX = _frameInput.Move.x < 0;
                spAni.SetBool("run",true);
            }
            else
            {
                spAni.SetBool("run",false);
            }
